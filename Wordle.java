...
public class Wordle {
    ...
    private void createGUI() {
        ...
        resultPanel.setLayout(new GridLayout(6, 5));
        resultLabels = new JLabel[30];
        for (int i = 0; i < 30; i++) {
            resultLabels[i] = new JLabel("");
            resultLabels[i].setBorder(BorderFactory.createLineBorder(Color.BLACK));
            resultLabels[i].setHorizontalAlignment(JLabel.CENTER);
            resultLabels[i].setFont(new Font("Monospaced", Font.BOLD, 24));
        ...
        keyboardPanel.setLayout(new GridLayout(3, 10));
    ...
    private void startNewGame() {
        ...
        for (int i = 0; i < resultLabels.length; i++) {
            ...
            resultLabels[i].setBackground(Color.WHITE); //reset bg
        }
    }
    ...
    private class KeyboardListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            if (attempts < 6 && inputField != null && inputField.getText().length() < 5) {
    ...
    private class EnterListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            if (inputField != null && inputField.getText().length() == 5) {
                displayResult(inputField.getText());
    ...
    private void showWinDialog() {
        JOptionPane.showMessageDialog(frame, "Congratulations! You guessed the word: " + targetWord, "You Win!", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void gameOver() {
        int response = JOptionPane.showConfirmDialog(frame, "Game Over! The word was " + targetWord + ". Do you want to play again?", "Game Over",
